...
interface IOneOfUs {
    function init(uint128 _value, bool _encodeReply) external returns (bytes32 messageId);

    function oneOfUsJoinUs(uint128 _value, bool _encodeReply) external returns (bytes32 messageId);

    function oneOfUsCount(uint128 _value, bool _encodeReply) external returns (bytes32 messageId);

    function oneOfUsIsOneOfUs(uint128 _value, bool _encodeReply, bytes32 addr) external returns (bytes32 messageId);

    function oneOfUsList(uint128 _value, bool _encodeReply, uint32 page, uint32 pageSize)
        external
        returns (bytes32 messageId);

    function oneOfUsVersion(uint128 _value, bool _encodeReply) external returns (bytes32 messageId);
}
