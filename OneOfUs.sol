...
interface IOneOfUsCallbacks {
    ...
    function replyOn_oneOfUsList(bytes32 messageId, uint16[16][] calldata reply) external;
...
contract OneOfUsCaller is IOneOfUsCallbacks {
    ...
    function replyOn_oneOfUsList(bytes32 messageId, uint16[16][] calldata reply) external onlyGearExeProgram {
        // TODO: implement this
    }
